...
public abstract class EventLoopImplBase extends EventLoopImplPlatform implements Delay {
    ...
    public void mo1523scheduleResumeAfterDelay(long j, CancellableContinuation<? super Unit> cancellableContinuation) {
    ...
    */
    ...
    public final void mo1522dispatch(CoroutineContext coroutineContext, Runnable runnable) {
        enqueue(runnable);
    }
    ...
    private final void closeQueue() {
        ...
        while (true) {
            ...
            if (obj == null) {
                ...
                if (SafePublicationLazyImpl$$ExternalSyntheticBackportWithForwarding0.m(_queue$FU, this, obj, lockFreeTaskQueueCore)) {
                    return;
                }
            } else {
    ...
    private final int scheduleImpl(long j, DelayedTask delayedTask) {
        ...
        if (delayedTaskQueue == null) {
            SafePublicationLazyImpl$$ExternalSyntheticBackportWithForwarding0.m(_delayed$FU, this, null, new DelayedTaskQueue(j));
    ...
    private final boolean enqueueImpl(Runnable runnable) {
        ...
        while (true) {
            ...
            if (obj == null) {
                if (SafePublicationLazyImpl$$ExternalSyntheticBackportWithForwarding0.m(_queue$FU, this, null, runnable)) {
                    return true;
                }
            } else if (!(obj instanceof LockFreeTaskQueueCore)) {
                symbol = EventLoop_commonKt.CLOSED_EMPTY;
                ...
                if (addLast == 1) {
                    SafePublicationLazyImpl$$ExternalSyntheticBackportWithForwarding0.m(_queue$FU, this, obj, lockFreeTaskQueueCore2.next());
                } else if (addLast == 2) {
                    return false;
                }
            }
    ...
    private final Runnable dequeue() {
        ...
        while (true) {
            ...
            if (!(obj instanceof LockFreeTaskQueueCore)) {
                ...
                if (SafePublicationLazyImpl$$ExternalSyntheticBackportWithForwarding0.m(_queue$FU, this, obj, null)) {
                    Objects.requireNonNull(obj, "null cannot be cast to non-null type java.lang.Runnable{ kotlinx.coroutines.RunnableKt.Runnable }");
                    return (Runnable) obj;
                }
            } else {
                ...
                SafePublicationLazyImpl$$ExternalSyntheticBackportWithForwarding0.m(_queue$FU, this, obj, lockFreeTaskQueueCore.next());
            }
        }
    }
}
