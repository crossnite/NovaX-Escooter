...
public final class MutexImpl implements Mutex, SelectClause2<Object, Mutex> {
    ...
    public <R> void registerSelectClause2(SelectInstance<? super R> selectInstance, Object obj, Function2<? super Mutex, ? super Continuation<? super R>, ? extends Object> function2) {
        ...
        while (!selectInstance.isSelected()) {
            ...
            if (obj2 instanceof Empty) {
                ...
                if (obj3 != symbol) {
                    SafePublicationLazyImpl$$ExternalSyntheticBackportWithForwarding0.m(_state$FU, this, obj2, new LockedQueue(empty.locked));
                } else {
    ...
    private static final class TryLockDesc extends AtomicDesc {
        ...
        private final class PrepareOp extends OpDescriptor {
            ...
            public Object perform(Object obj) {
                ...
                SafePublicationLazyImpl$$ExternalSyntheticBackportWithForwarding0.m(MutexImpl._state$FU, (MutexImpl) obj, this, atomicOp);
                return null;
            }
        }
        ...
        public Object prepare(AtomicOp<?> atomicOp) {
            ...
            if (!SafePublicationLazyImpl$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater, mutexImpl, empty, prepareOp)) {
        ...
        public void complete(AtomicOp<?> atomicOp, Object obj) {
            ...
            SafePublicationLazyImpl$$ExternalSyntheticBackportWithForwarding0.m(MutexImpl._state$FU, this.mutex, atomicOp, empty);
        }
    }
    ...
    private static final class UnlockOp extends AtomicOp<MutexImpl> {
        ...
        public void complete(MutexImpl mutexImpl, Object obj) {
            SafePublicationLazyImpl$$ExternalSyntheticBackportWithForwarding0.m(MutexImpl._state$FU, mutexImpl, this, obj == null ? MutexKt.EMPTY_UNLOCKED : this.queue);
        }
    }
    ...
    public boolean tryLock(Object obj) {
        ...
        while (true) {
            ...
            if (obj2 instanceof Empty) {
                ...
                if (SafePublicationLazyImpl$$ExternalSyntheticBackportWithForwarding0.m(_state$FU, this, obj2, obj == null ? MutexKt.EMPTY_LOCKED : new Empty(obj))) {
                    return true;
                }
            } else if (obj2 instanceof LockedQueue) {
