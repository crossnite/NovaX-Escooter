...
public final class SelectBuilderImpl<R> extends LockFreeLinkedListHead implements SelectBuilder<R>, SelectInstance<R>, Continuation<R>, CoroutineStackFrame {
    ...
    private final void doResume(Function0<? extends Object> function0, Function0<Unit> function02) {
        ...
        while (true) {
            ...
            if (obj == SelectKt.access$getUNDECIDED$p()) {
                if (SafePublicationLazyImpl$$ExternalSyntheticBackportWithForwarding0.m(_result$FU, this, SelectKt.access$getUNDECIDED$p(), function0.invoke())) {
                    return;
                }
    ...
    public static final class PairSelectOp extends OpDescriptor {
        ...
        public Object perform(Object obj) {
            ...
            SafePublicationLazyImpl$$ExternalSyntheticBackportWithForwarding0.m(SelectBuilderImpl._state$FU, selectBuilderImpl, this, decide == null ? this.otherOp.desc : SelectKt.getNOT_SELECTED());
            return decide;
        }
    ...
    public static final class AtomicSelectOp extends AtomicOp<Object> {
        ...
        private final void completeSelect(Object obj) {
            boolean z = obj == null;
            if (SafePublicationLazyImpl$$ExternalSyntheticBackportWithForwarding0.m(SelectBuilderImpl._state$FU, this.impl, this, z ? null : SelectKt.getNOT_SELECTED()) && z) {
    ...
    public void resumeWith(Object obj) {
        ...
        while (true) {
            ...
            if (obj2 == SelectKt.access$getUNDECIDED$p()) {
                if (SafePublicationLazyImpl$$ExternalSyntheticBackportWithForwarding0.m(_result$FU, this, SelectKt.access$getUNDECIDED$p(), CompletionStateKt.toState$default(obj, null, 1, null))) {
                    return;
                }
                ...
                if (SafePublicationLazyImpl$$ExternalSyntheticBackportWithForwarding0.m(_result$FU, this, IntrinsicsKt.getCOROUTINE_SUSPENDED(), SelectKt.access$getRESUMED$p())) {
                    if (Result.m46isFailureimpl(obj)) {
                        ...
                        Intrinsics.checkNotNull(m43exceptionOrNullimpl);
                        Result.Companion companion = Result.Companion;
                        if (DebugKt.getRECOVER_STACK_TRACES() && (continuation instanceof CoroutineStackFrame)) {
                            m43exceptionOrNullimpl = StackTraceRecoveryKt.recoverFromStackFrame(m43exceptionOrNullimpl, (CoroutineStackFrame) continuation);
                        }
                        continuation.resumeWith(Result.m40constructorimpl(ResultKt.createFailure(m43exceptionOrNullimpl)));
                        return;
                    }
        ...
        while (true) {
            ...
            if (obj == SelectKt.access$getUNDECIDED$p()) {
                ...
                if (SafePublicationLazyImpl$$ExternalSyntheticBackportWithForwarding0.m(_result$FU, this, IntrinsicsKt.getCOROUTINE_SUSPENDED(), SelectKt.access$getRESUMED$p())) {
                    ...
                    Result.Companion companion = Result.Companion;
                    intercepted.resumeWith(Result.m40constructorimpl(ResultKt.createFailure(th)));
                    return;
                }
            }
        }
    ...
    */
    public java.lang.Object trySelectOther(kotlinx.coroutines.internal.LockFreeLinkedListNode.PrepareOp r4) {
        ...
        L0:
            ...
            java.lang.Object r1 = kotlinx.coroutines.selects.SelectKt.getNOT_SELECTED()
            boolean r0 = kotlin.SafePublicationLazyImpl$$ExternalSyntheticBackportWithForwarding0.m(r0, r3, r1, r2)
            if (r0 != 0) goto L31
            goto L0
        L18:
            ...
            boolean r1 = kotlin.SafePublicationLazyImpl$$ExternalSyntheticBackportWithForwarding0.m(r1, r3, r2, r0)
            if (r1 != 0) goto L2a
            goto L0
        L2a:
