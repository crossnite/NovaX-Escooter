...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            m40constructorimpl = Result.m40constructorimpl(property == null ? null : Boolean.valueOf(Boolean.parseBoolean(property)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            m40constructorimpl = Result.m40constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = Result.m46isFailureimpl(m40constructorimpl) ? null : m40constructorimpl;
        ...
        try {
            Signal.handle(new Signal("TRAP"), new SignalHandler() { // from class: kotlinx.coroutines.debug.AgentPremain$$ExternalSyntheticLambda0
                public final void handle(Signal signal) {
                    AgentPremain.m1500installSignalHandler$lambda1(signal);
                }
            });
    ...
    public static final void m1500installSignalHandler$lambda1(Signal signal) {
