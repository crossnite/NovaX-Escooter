...
public final /* synthetic */ class FlowKt__LimitKt {
    public static final /* synthetic */ Object access$emitAbort$FlowKt__LimitKt(FlowCollector flowCollector, Object obj, Continuation continuation) {
    ...
    public static final <T> Flow<T> drop(final Flow<? extends T> flow, final int i) {
        ...
        return new Flow<T>() { // from class: kotlinx.coroutines.flow.FlowKt__LimitKt$drop$$inlined$unsafeFlow$1
            ...
            public Object collect(final FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) {
                ...
                final int i2 = i;
                Object collect = flow2.collect((FlowCollector) ((FlowCollector<T>) new FlowCollector<T>() { // from class: kotlinx.coroutines.flow.FlowKt__LimitKt$drop$lambda-2$$inlined$collect$1
