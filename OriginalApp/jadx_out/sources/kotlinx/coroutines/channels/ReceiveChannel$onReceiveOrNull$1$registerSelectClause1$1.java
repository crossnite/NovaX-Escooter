...
final class ReceiveChannel$onReceiveOrNull$1$registerSelectClause1$1<E, R> extends SuspendLambda implements Function2<ChannelResult<? extends E>, Continuation<? super R>, Object> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object obj, Object obj2) {
        return m1499invokeWpGqRn0(((ChannelResult) obj).m1495unboximpl(), (Continuation) obj2);
    }

    /* renamed from: invoke-WpGqRn0  reason: not valid java name */
    public final Object m1499invokeWpGqRn0(Object obj, Continuation<? super R> continuation) {
        return ((ReceiveChannel$onReceiveOrNull$1$registerSelectClause1$1) create(ChannelResult.m1483boximpl(obj), continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            Object m1495unboximpl = ((ChannelResult) this.L$0).m1495unboximpl();
            Throwable m1487exceptionOrNullimpl = ChannelResult.m1487exceptionOrNullimpl(m1495unboximpl);
            if (m1487exceptionOrNullimpl != null) {
                throw m1487exceptionOrNullimpl;
            }
            Object m1488getOrNullimpl = ChannelResult.m1488getOrNullimpl(m1495unboximpl);
            this.label = 1;
            obj = this.$block.invoke(m1488getOrNullimpl, this);
