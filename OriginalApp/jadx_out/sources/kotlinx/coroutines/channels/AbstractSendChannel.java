...
public abstract class AbstractSendChannel<E> implements SendChannel<E> {
    ...
    */
    ...
    public final Object mo1478trySendJP2dKIU(E e) {
        Object offerInternal = offerInternal(e);
        if (offerInternal == AbstractChannelKt.OFFER_SUCCESS) {
            return ChannelResult.Companion.m1498successJP2dKIU(Unit.INSTANCE);
        }
        if (offerInternal == AbstractChannelKt.OFFER_FAILED) {
            Closed<?> closedForSend = getClosedForSend();
            return closedForSend == null ? ChannelResult.Companion.m1497failurePtdJZtk() : ChannelResult.Companion.m1496closedJP2dKIU(helpCloseAndGetSendException(closedForSend));
        } else if (offerInternal instanceof Closed) {
            return ChannelResult.Companion.m1496closedJP2dKIU(helpCloseAndGetSendException((Closed) offerInternal));
        } else {
    ...
    public final void helpCloseAndResumeWithSendException(Continuation<?> continuation, E e, Closed<?> closed) {
        ...
        if (function1 != null && (callUndeliveredElementCatchingException$default = OnUndeliveredElementKt.callUndeliveredElementCatchingException$default(function1, e, null, 2, null)) != null) {
            ...
            continuation.resumeWith(Result.m40constructorimpl(ResultKt.createFailure(undeliveredElementException)));
            return;
        }
        Result.Companion companion2 = Result.Companion;
        continuation.resumeWith(Result.m40constructorimpl(ResultKt.createFailure(sendException)));
    }
    ...
    private final void invokeOnCloseHandler(Throwable th) {
        ...
        if (obj == null || obj == AbstractChannelKt.HANDLER_INVOKED || !SafePublicationLazyImpl$$ExternalSyntheticBackportWithForwarding0.m(onCloseHandler$FU, this, obj, AbstractChannelKt.HANDLER_INVOKED)) {
            return;
        }
    ...
    public void invokeOnClose(Function1<? super Throwable, Unit> function1) {
        ...
        Closed<?> closedForSend = getClosedForSend();
        if (closedForSend == null || !SafePublicationLazyImpl$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater, this, function1, AbstractChannelKt.HANDLER_INVOKED)) {
            return;
        }
    ...
    private final void helpClose(Closed<?> closed) {
        ...
        while (true) {
            ...
            if (receive == null) {
                ...
                m1514constructorimpl$default = InlineList.m1519plusFjFbRPM(m1514constructorimpl$default, receive);
            }
        }
        if (m1514constructorimpl$default != null) {
            if (!(m1514constructorimpl$default instanceof ArrayList)) {
                ((Receive) m1514constructorimpl$default).resumeReceiveClosed(closed);
            } else {
                Objects.requireNonNull(m1514constructorimpl$default, "null cannot be cast to non-null type java.util.ArrayList<E of kotlinx.coroutines.internal.InlineList>{ kotlin.collections.TypeAliasesKt.ArrayList<E of kotlinx.coroutines.internal.InlineList> }");
                ArrayList arrayList = (ArrayList) m1514constructorimpl$default;
    ...
    public final Object sendSuspend(E e, Continuation<? super Unit> continuation) {
        ...
        while (true) {
            ...
            if (offerInternal == AbstractChannelKt.OFFER_SUCCESS) {
                ...
                Result.Companion companion = Result.Companion;
                cancellableContinuationImpl.resumeWith(Result.m40constructorimpl(unit));
                break;
