...
public interface SendChannel<E> {
    ...
    Object mo1478trySendJP2dKIU(E e);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            Object mo1478trySendJP2dKIU = sendChannel.mo1478trySendJP2dKIU(e);
            if (ChannelResult.m1493isSuccessimpl(mo1478trySendJP2dKIU)) {
                return true;
            }
            Throwable m1487exceptionOrNullimpl = ChannelResult.m1487exceptionOrNullimpl(mo1478trySendJP2dKIU);
