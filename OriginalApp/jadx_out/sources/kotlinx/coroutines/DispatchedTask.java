    ...
    public final void run() {
        ...
        try {
            ...
            if (job != null && !job.isActive()) {
                ...
                continuation.resumeWith(Result.m40constructorimpl(successfulResult$kotlinx_coroutines_core));
            }
            ...
            try {
                ...
                m40constructorimpl2 = Result.m40constructorimpl(ResultKt.createFailure(th));
            }
            handleFatalException(null, Result.m43exceptionOrNullimpl(m40constructorimpl2));
        } catch (Throwable th2) {
            try {
                ...
                m40constructorimpl = Result.m40constructorimpl(ResultKt.createFailure(th3));
            }
            handleFatalException(th2, Result.m43exceptionOrNullimpl(m40constructorimpl));
        }
    }
