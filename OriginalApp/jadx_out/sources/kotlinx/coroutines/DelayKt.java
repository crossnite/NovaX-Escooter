    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < LongCompanionObject.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo1523scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
    ...
    public static final Object m1462delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m1463toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m1463toDelayMillisLRDsOJo(long j) {
        if (Duration.m1321compareToLRDsOJo(j, Duration.Companion.m1424getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1340getInWholeMillisecondsimpl(j), 1L);
        }
        return 0L;
    }
}
