        ...
        while (i < length) {
            ...
            if (t != t2) {
                ...
                if ((t instanceof Object[]) && (t2 instanceof Object[])) {
                    ...
                    if (!UArraysKt.m582contentEqualskV0jMPg(((UByteArray) t).m124unboximpl(), ((UByteArray) t2).m124unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UShortArray) && (t2 instanceof UShortArray)) {
                    if (!UArraysKt.m579contentEqualsFGO6Aew(((UShortArray) t).m384unboximpl(), ((UShortArray) t2).m384unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UIntArray) && (t2 instanceof UIntArray)) {
                    if (!UArraysKt.m580contentEqualsKJPZfPQ(((UIntArray) t).m202unboximpl(), ((UIntArray) t2).m202unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof ULongArray) && (t2 instanceof ULongArray)) {
                    if (!UArraysKt.m584contentEqualslec5QzE(((ULongArray) t).m280unboximpl(), ((ULongArray) t2).m280unboximpl())) {
                        return false;
                    }
        ...
        while (i < length) {
            ...
            if (t == null) {
                ...
                if (t instanceof UByteArray) {
                    ...
                    sb.append(UArraysKt.m596contentToString2csIQuQ(uByteArray != null ? uByteArray.m124unboximpl() : null));
                } else if (t instanceof UShortArray) {
                    UShortArray uShortArray = (UShortArray) t;
                    sb.append(UArraysKt.m600contentToStringd6D3K8(uShortArray != null ? uShortArray.m384unboximpl() : null));
                } else if (t instanceof UIntArray) {
                    UIntArray uIntArray = (UIntArray) t;
                    sb.append(UArraysKt.m599contentToStringXUkPCBk(uIntArray != null ? uIntArray.m202unboximpl() : null));
                } else if (t instanceof ULongArray) {
                    ULongArray uLongArray = (ULongArray) t;
                    sb.append(UArraysKt.m602contentToStringuLth9ew(uLongArray != null ? uLongArray.m280unboximpl() : null));
                } else {
