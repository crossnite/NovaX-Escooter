...
public final class UInt implements Comparable<UInt> {
    ...
    public /* bridge */ /* synthetic */ int compareTo(UInt uInt) {
        return UnsignedKt.uintCompare(m185unboximpl(), uInt.m185unboximpl());
    }
    ...
    private static final int m129compareTo7apg3OU(int i, byte b) {
        return UnsignedKt.uintCompare(i, m134constructorimpl(b & UByte.MAX_VALUE));
    }

    /* renamed from: compareTo-xj2QHRw  reason: not valid java name */
    private static final int m133compareToxj2QHRw(int i, short s) {
        return UnsignedKt.uintCompare(i, m134constructorimpl(s & UShort.MAX_VALUE));
    }

    /* renamed from: compareTo-WZ4Q5Ns  reason: not valid java name */
    private int m131compareToWZ4Q5Ns(int i) {
        return UnsignedKt.uintCompare(m185unboximpl(), i);
    }
    ...
    private static final int m130compareToVKZWuLQ(int i, long j) {
        return UnsignedKt.ulongCompare(ULong.m212constructorimpl(i & KeyboardMap.kValueMask), j);
    }

    /* renamed from: plus-7apg3OU  reason: not valid java name */
    private static final int m158plus7apg3OU(int i, byte b) {
        return m134constructorimpl(i + m134constructorimpl(b & UByte.MAX_VALUE));
    }

    /* renamed from: plus-xj2QHRw  reason: not valid java name */
    private static final int m161plusxj2QHRw(int i, short s) {
        return m134constructorimpl(i + m134constructorimpl(s & UShort.MAX_VALUE));
    }
    ...
    private static final long m159plusVKZWuLQ(int i, long j) {
        return ULong.m212constructorimpl(ULong.m212constructorimpl(i & KeyboardMap.kValueMask) + j);
    }
    ...
    private static final int m136div7apg3OU(int i, byte b) {
        return UnsignedKt.m387uintDivideJ1ME1BU(i, m134constructorimpl(b & UByte.MAX_VALUE));
    }

    /* renamed from: div-xj2QHRw  reason: not valid java name */
    private static final int m139divxj2QHRw(int i, short s) {
        return UnsignedKt.m387uintDivideJ1ME1BU(i, m134constructorimpl(s & UShort.MAX_VALUE));
    }

    /* renamed from: div-WZ4Q5Ns  reason: not valid java name */
    private static final int m138divWZ4Q5Ns(int i, int i2) {
        return UnsignedKt.m387uintDivideJ1ME1BU(i, i2);
    }

    /* renamed from: div-VKZWuLQ  reason: not valid java name */
    private static final long m137divVKZWuLQ(int i, long j) {
        return UnsignedKt.m389ulongDivideeb3DHEI(ULong.m212constructorimpl(i & KeyboardMap.kValueMask), j);
    }

    /* renamed from: rem-7apg3OU  reason: not valid java name */
    private static final int m163rem7apg3OU(int i, byte b) {
        return UnsignedKt.m388uintRemainderJ1ME1BU(i, m134constructorimpl(b & UByte.MAX_VALUE));
    }

    /* renamed from: rem-xj2QHRw  reason: not valid java name */
    private static final int m166remxj2QHRw(int i, short s) {
        return UnsignedKt.m388uintRemainderJ1ME1BU(i, m134constructorimpl(s & UShort.MAX_VALUE));
    }

    /* renamed from: rem-WZ4Q5Ns  reason: not valid java name */
    private static final int m165remWZ4Q5Ns(int i, int i2) {
        return UnsignedKt.m388uintRemainderJ1ME1BU(i, i2);
    }

    /* renamed from: rem-VKZWuLQ  reason: not valid java name */
    private static final long m164remVKZWuLQ(int i, long j) {
        return UnsignedKt.m390ulongRemaindereb3DHEI(ULong.m212constructorimpl(i & KeyboardMap.kValueMask), j);
    }
    ...
    private static final byte m153mod7apg3OU(int i, byte b) {
        return UByte.m58constructorimpl((byte) UnsignedKt.m388uintRemainderJ1ME1BU(i, m134constructorimpl(b & UByte.MAX_VALUE)));
    }

    /* renamed from: mod-xj2QHRw  reason: not valid java name */
    private static final short m156modxj2QHRw(int i, short s) {
        return UShort.m318constructorimpl((short) UnsignedKt.m388uintRemainderJ1ME1BU(i, m134constructorimpl(s & UShort.MAX_VALUE)));
    }
    ...
    private static final byte m180toUBytew2LRezQ(int i) {
        return UByte.m58constructorimpl((byte) i);
    }

    /* renamed from: toUShort-Mh2AYeg  reason: not valid java name */
    private static final short m183toUShortMh2AYeg(int i) {
        return UShort.m318constructorimpl((short) i);
    }

    /* renamed from: toULong-s-VKNKU  reason: not valid java name */
    private static final long m182toULongsVKNKU(int i) {
        return ULong.m212constructorimpl(i & KeyboardMap.kValueMask);
    }
