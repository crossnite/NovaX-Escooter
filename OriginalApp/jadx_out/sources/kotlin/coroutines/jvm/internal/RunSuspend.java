...
final class RunSuspend implements Continuation<Unit> {
    ...
    public final Result<Unit> m1227getResultxLWZpok() {
        return this.result;
    }
    ...
    public void resumeWith(Object obj) {
        synchronized (this) {
            setResult(Result.m39boximpl(obj));
            notifyAll();
    ...
    public final void await() {
        synchronized (this) {
            while (true) {
                Result<Unit> m1227getResultxLWZpok = m1227getResultxLWZpok();
                if (m1227getResultxLWZpok == null) {
                    wait();
                } else {
                    ResultKt.throwOnFailure(m1227getResultxLWZpok.m49unboximpl());
                }
            }
        }
    }
