...
public final class Result<T> implements Serializable {
    ...
    public static final /* synthetic */ Result m39boximpl(Object obj) {
        return new Result(obj);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static <T> Object m40constructorimpl(Object obj) {
        return obj;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m41equalsimpl(Object obj, Object obj2) {
        return (obj2 instanceof Result) && Intrinsics.areEqual(obj, ((Result) obj2).m49unboximpl());
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m42equalsimpl0(Object obj, Object obj2) {
    ...
    public static int m45hashCodeimpl(Object obj) {
        if (obj == null) {
            return 0;
        }
        return obj.hashCode();
    ...
    public final /* synthetic */ Object m49unboximpl() {
        return this.value;
    }
    ...
    public static final boolean m47isSuccessimpl(Object obj) {
        return !(obj instanceof Failure);
    }

    /* renamed from: isFailure-impl  reason: not valid java name */
    public static final boolean m46isFailureimpl(Object obj) {
        return obj instanceof Failure;
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: getOrNull-impl  reason: not valid java name */
    private static final T m44getOrNullimpl(Object obj) {
        if (m46isFailureimpl(obj)) {
            return null;
        }
        return obj;
    }
    ...
    public static final Throwable m43exceptionOrNullimpl(Object obj) {
    ...
    public static final class Companion {
        ...
        private final <T> Object success(T t) {
            return Result.m40constructorimpl(t);
        }

        private final <T> Object failure(Throwable exception) {
            Intrinsics.checkNotNullParameter(exception, "exception");
            return Result.m40constructorimpl(ResultKt.createFailure(exception));
        }
    }
