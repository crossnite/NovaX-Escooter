...
final class AdjustedTimeMark extends TimeMark {
    ...
    public final long m1317getAdjustmentUwyO8pc() {
    ...
    public long mo1315elapsedNowUwyO8pc() {
        return Duration.m1357minusLRDsOJo(this.mark.mo1315elapsedNowUwyO8pc(), m1317getAdjustmentUwyO8pc());
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo1316plusLRDsOJo(long j) {
        return new AdjustedTimeMark(this.mark, Duration.m1358plusLRDsOJo(m1317getAdjustmentUwyO8pc(), j), null);
    }
}
